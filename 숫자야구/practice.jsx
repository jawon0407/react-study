            ...
            if(tries.length >= 9){
                ...
                for(i=0;i<4;i++){
                    ...
                    this.setState((prevState) => ({
                        ...
                        value : '',
                        tries : [...prevState.tries, {tryInfo : value, result : `${strike} 스트라이크, ${ball} 볼입니다.`}]
                    }))
                }
            }
        ...
        return(
            <>
                ...
                <form onSubmit={this.onSubmitForm}>
                    <input ref={this.inputEl} value={value} onChange={this.onChangeFunc}/>
                    <button>입력</button>
                </form>
                ...
                <ul>
                    {tries.map((v,i) => {
                        return(
                            <li key={`${i+1}차 시도 : ${v.tryInfo}`}><b>{v.tryInfo}</b> - {v.result}</li>
                        )
                    })}
                </ul>
            </>
